...
<br><br><br>
      ...
      <div class="col-md-4">
        ...
        <form style="width: 400px;" action="_updatepackage.php" method="POST">
...
?>
 ...
 <div class="form-outline mb-4">
        ...
        <div class="form-outline mb-4">
          ...
          <input type="text" id="form1Example2" class="form-control" name="price" value="<?php echo $output['price'];?>"/>
        </div>
