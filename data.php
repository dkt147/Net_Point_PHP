...
include 'config.php';
$sql = "SELECT payment.pid,users.id,users.name,payment.serial,payment.date,payment.amount_type,payment.type,payment.amount,payment.balance,payment.package,payment.Month,payment.Year FROM `payment` INNER JOIN users ON users.id=payment.u_id Order by date desc";
...
?>
            ...
            <tr>
                ...
                <td><a href="update_data.php?uid=<?php echo $output['pid'];?>"><i class="fa fa-edit"
                            style="font-size:25px"></i></a></td>
                            
                <td><a href="delete_data.php?uid=<?php echo $output['pid'];?>"><i class="fa fa-edit"
                            style="font-size:25px"></i></a></td>
